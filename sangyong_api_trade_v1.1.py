...
if __name__ == "__main__":
    cpdax_address = "https://www.cpdax.com"   # Cheetah stage=> Changed
    ...
    # Product rsi@coinplug.com
    api_key = "570d5365ed70d528ca2f4f85002f40fd679ae3355e95835c91b7f391076b9e3e"    #rsi@coinplug.com
    secret_key = "YTI4Zjg2ODMtZmNiOC00NTAwLWE1OGQtYzEwMWQ0NGY5ZmI2" #rsi@coinplug.com
    cpdax_obj = cpdax(api_key, secret_key)

    ## order test user
    # user 1 - level : ?, order ratio : ?
    user1_api_key = ""
    user1_secret_key = ""
    user1_cpdax = cpdax(user1_api_key, user1_secret_key)

    # user 2 - level : ?, order ratio : ?
    user2_api_key = ""
    user2_secret_key = ""
    ...
    while 1:
        ...
        if operation == "1":
            ...
            product_id = raw_input("Input productId(BTC-KRW) : ")
            ...
            product_id = raw_input("Input productId : ")
            start = raw_input("start time(optional:utc) : ")
            end = raw_input("end time(optional:utc) : ")
            limit = raw_input("limit(optional) : ")
            page = raw_input("page(optional) : ")
